...
from dsystem.public_storage import upload_public_bytes
from dsystem.storage import upload_bytes
...
async def upload_to_storage(
    ...
    *,
    ...
    try:
        ...
        _log.error("object storage upload failed for %s: %s", storage_path, exc)
